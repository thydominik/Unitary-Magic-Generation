...
savefig(p, "N4_Depth_vs_reg.pdf")
savefig(p, "N4_Depth_vs_reg.png")
...
savefig(p, "N4_RegularCircuit_MagicDistribution.pdf")
savefig(p, "N4_RegularCircuit_MagicDistribution.png")
...
@save "N4_Statistis.jld2" counts bin_edges samples Mean Median Skewness kurtosis Variance
...
title!(L"Mean $N = 4$", titlefontsize=20)
...
savefig(p, "N4_sample_vs_mean.pdf")
savefig(p, "N4_sample_vs_mean.png")
...
title!(L"Median $N = 4$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
title!(L"Variance $N = 4$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
title!(L"Skewness $N = 4$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
title!(L"Kurtosis $N = 4$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
SVN = Vector{Float64}()
for i in 1:(2^20)
    push!(SVN, round(minimum(data[1]["Entanglement"][i][:]), digits=14))
end
...
title!(L"Kernel Density: $min(S_{VN})$ vs $M_2$ $N = 4$", titlefontsize=20)
xlabel!(L"$\tilde{M}_2$",      labelfontsize=20)
...
savefig(p, "N$(No_Qubits)_SVN_vs_M2_min.pdf")
savefig(p, "N$(No_Qubits)_SVN_vs_M2_min.png")