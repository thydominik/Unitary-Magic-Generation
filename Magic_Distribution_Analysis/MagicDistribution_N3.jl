...
# Loading data -------------------------------------------------------------------------------------------------------------------------------------------
data = Dict()
dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\RegularUnitaryCircuitMagicSampled_N_3_Samples_1048576_Seed_1.jld2"
data[1]    = JLD2.load(dataPath)
dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\BWUnitaryCircuitMagicSampled_N_3_D_1_Samples_1048576_Seed_1.jld2"
data[2] = JLD2.load(dataPath)
dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\BWUnitaryCircuitMagicSampled_N_3_D_2_Samples_1048576_Seed_1.jld2"
data[3] = JLD2.load(dataPath)
dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\BWUnitaryCircuitMagicSampled_N_3_D_3_Samples_1048576_Seed_1.jld2"
data[4] = JLD2.load(dataPath)
dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\BWUnitaryCircuitMagicSampled_N_3_D_4_Samples_1048576_Seed_1.jld2"
data[5] = JLD2.load(dataPath)

dataPath = "D:\\Data\\Random_Unitary_Magic_Generation\\RegularUnitaryCircuitMagicSampled_N_2_Samples_1048576_Seed_1.jld2"
M2_2    = JLD2.load(dataPath)

# Manipulation of data -------------------------------------------------------------------------------------------------------------------------------------------

M2 = Dict()
for i in range(1, No_Data)
    M2[i] = round.(data[i]["Magic"] ./ log(9/2),    digits=14)
end
...
# plotting -------------------------------------------------------------------------------------------------------------------------------------------
p = plot(dpi=400)
plot!(bin_edges[1:length(bin_edges)-1], (counts[1]), lw=10, label="Regular circuit", legend=:topleft)
plot!(bin_edges[1:length(bin_edges)-1],  (counts[2]), lw=2, label="BW - D = 1", legend=:topleft)
plot!(bin_edges[1:length(bin_edges)-1], (counts[3]), lw=2, label="BW - D = 2", legend=:topleft)
plot!(bin_edges[1:length(bin_edges)-1], (counts[4]), lw=2, label="BW - D = 3", legend=:topleft)
plot!(bin_edges[1:length(bin_edges)-1], (counts[5]), lw=2, label="BW - D = 4", legend=:topleft)
theme(:mute::Symbol;)

title!(L"Magic Distribution $N = 3$ and $D = 1-4$",   titlefontsize=20)
...
savefig(p, "N3_Depth_vs_reg.pdf")
savefig(p, "N3_Depth_vs_reg.png")

# plotting -------------------------------------------------------------------------------------------------------------------------------------------
p = plot(dpi=400)
plot!(bin_edges[1:length(bin_edges)-1], (counts[1]), lw=2, label="Magic Distribution", legend=:topleft)
vline!([Quantiles[1][1]], color=:red,      label="25% = $(round(a[1], digits=5))")
vline!([Quantiles[1][2]], color=:green,    label="50% = $(round(a[2], digits=5))")
vline!([Quantiles[1][3]], color=:blue,     label="75% = $(round(a[3], digits=5))")
...
title!(L"Magic Distribution $N = 3$",   titlefontsize=20)
xlabel!(L"$\tilde{M}_2$",               labelfontsize=20)
ylabel!(L"$\varrho(\tilde{M}_2)$",      labelfontsize=20)
...
savefig(p, "N3_RegularCircuit_MagicDistribution.pdf")
savefig(p, "N3_RegularCircuit_MagicDistribution.png")

# plotting -------------------------------------------------------------------------------------------------------------------------------------------

p = plot(dpi=400)
plot!(bin_edges[1:length(bin_edges)-1], (counts[2]), lw=6, label="Magic Distribution N = 3, D = 1", legend=:bottomright)
h2 = fit(Histogram, M2_2["Magic"] ./ log(9/2), bin_edges)
...
@save "N3_Statistis.jld2" counts bin_edges samples Mean Median Skewness kurtosis Variance
...
title!(L"Mean $N = 3$", titlefontsize=20)
...
savefig(p, "N3_sample_vs_mean.pdf")
savefig(p, "N3_sample_vs_mean.png")
...
title!(L"Median $N = 3$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
savefig(p, "N3_sample_vs_median.pdf")
savefig(p, "N3_sample_vs_median.png")
...
title!(L"Variance $N = 3$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
savefig(p, "N3_sample_vs_var.pdf")
savefig(p, "N3_sample_vs_var.png")
...
title!(L"Skewness $N = 3$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
savefig(p, "N3_sample_vs_skew.pdf")
savefig(p, "N3_sample_vs_skew.png")
...
title!(L"Kurtosis $N = 3$", titlefontsize=20)
xlabel!("Sample size",      labelfontsize=20)
ylabel!(L"$\tilde{M}_2$",           labelfontsize=20)
...
savefig(p, "N3_sample_vs_Kurtosis.pdf")
savefig(p, "N3_sample_vs_Kurtosis.png")
...
title!(L"Kernel Density: $\langle(S_{VN})\rangle$ vs $M_2$ $N = 2$", titlefontsize=20)
xlabel!(L"$\tilde{M}_2$",      labelfontsize=20)
...
plot!(xlims=[0, 1])
plot!(ylims=[0, log2(2)])
savefig(p, "N3_SVN_vs_M2_avg.pdf")
savefig(p, "N3_SVN_vs_M2_avg.png")