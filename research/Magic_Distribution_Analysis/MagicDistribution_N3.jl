...
function main()
    ...
    if save_output
        out_pdf = output_path("N3_Depth_vs_reg.pdf"; script_dir=@__DIR__, script_file=@__FILE__)
        out_png = output_path("N3_Depth_vs_reg.png"; script_dir=@__DIR__, script_file=@__FILE__)
