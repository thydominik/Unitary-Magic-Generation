"""
MagicDistribution_N1.jl

See MagicDistribution_N4.jl for conventions.

Note
- For N=1, brickwall datasets may not exist depending on how data were generated.
  The script assumes the same naming pattern; adjust if needed.
"""
...
function main()
    ...
    if save_output
        out_pdf = output_path("N1_Depth_vs_reg.pdf"; script_dir=@__DIR__, script_file=@__FILE__)
        out_png = output_path("N1_Depth_vs_reg.png"; script_dir=@__DIR__, script_file=@__FILE__)
